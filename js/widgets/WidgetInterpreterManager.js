...
import { WorkflowControlInterpreter } from "./WorkflowControlInterpreter.js"; // UI для workflow control нод
...
const defaultInterpreters = [
    ...
    new WorkflowControlInterpreter(),// Приоритет 90 - кнопки/тогглы/слайдеры workflow control
    new LoadImageInterpreter(),      // Приоритет 90 - загрузка изображений (LoadImage)
    new PreviewImageInterpreter(),   // Приоритет 88 - предпросмотр (выше ImageInterpreter!)
    new ImageInterpreter(),          // Приоритет 85 - другие изображения
